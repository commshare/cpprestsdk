...
//using VersionStr = std::map<int, std::string>;
static const struct T_VersionStr
{
  Version v;
  const char* desc;
}VersionStr[] = 
{
  { Version::VERSION_PRE_XP,   "PRE_XP" },
  { Version::VERSION_XP ,"xp" },
  { Version::VERSION_SERVER_2003,  "XP Pro x64 and Server 2003 R2"},
  { Version::VERSION_VISTA  ,      "VISTA , Windows Server 2008" },
  { Version::VERSION_WIN7  ,      "WIN7 ,Windows Server 2008 R2" },
  { Version::VERSION_WIN8 ,         "WIN8, Windows Server 2012" },
  {Version::VERSION_WIN8_1 ,       "WIN8.1, Windows Server 2012 R2"},
  {Version::VERSION_WIN10 ,        "WIN10, Threshold 1: Version 1507, Build 10240"},
  {Version::VERSION_WIN10_TH2 ,    "WIN10, Threshold 2: Version 1511, Build 10586" },
  {Version::VERSION_WIN10_RS1 ,    "WIN10 Redstone 1: Version 1607, Build 14393"},
  { Version::VERSION_WIN10_RS2 ,   "WIN10 Redstone 2: Version 1703, Build 15063"},
  {Version::VERSION_WIN10_RS3,   "WIN10 Redstone 3: Version 1709, Build 16299"},
  {Version::VERSION_WIN10_RS4 ,  "WIN10 Redstone 4: Version 1803, Build 17134."},
  // On edit, update tools\metrics\histograms\enums.xml "WindowsVersion" and
  // "GpuBlacklistFeatureTestResultsWindows2".
  {Version::VERSION_WIN_LAST,"Indicates error condition."}
};
...
Version GetVersion();
__declspec(dllexport) std::string getosver();
}  // namespace rtc_win
}  // namespace rtc
